 ...
 * It separates Firebase code from UI code.
 * 
 * Think of it as: The worker that talks to Firebase
 * MainActivity.kt is: The manager that tells worker what to do
 */

class FirebaseHelper {
    
    // Get Firebase Auth instance
    // This is like getting the "keys" to Firebase's authentication system
